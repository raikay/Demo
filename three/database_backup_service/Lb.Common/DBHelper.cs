...
/******************************************
 * 类名：DBHelper(可以由自己随意定义)
 * 功能：访问数据库以及对数据库的一些操作
 * -----------------------------------------
 * 作者：刘百泉
 * 描述：在网上看了好多数据库通用类收集了很
 *       多而写出来的，大部分更能借鉴于51as
 *       px源码网站上的SQLHelper。
 * 创建：2010年5月10日 13:45:25
 * ****************************************/
...
namespace Lb.Common
{
    ...
    public static class DBHelper
    {
        ...
        public static string ConnectionString
        {
            ...
            {
                connection = null;
                return DBHelper.connectionString;// ConfigurationManager.ConnectionStrings["sqlserver"].ConnectionString;
            }
        }
